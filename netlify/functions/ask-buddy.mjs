...
export default async (request) => {
  ...
  const model = models.find((item) => item.name?.includes('flash') && item.supportedGenerationMethods?.includes('generateContent')) || models.find((item) => item.supportedGenerationMethods?.includes('generateContent'));
