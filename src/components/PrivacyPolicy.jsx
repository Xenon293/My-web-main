export function PrivacyPolicy({ headingId }) {
  return (
    <section className="privacy-policy" id="privacy">
      <div className="privacy-heading"><span className="eyebrow">Site information</span><h2 id={headingId}>Privacy &amp; Cookie Policy</h2><p>How this portfolio uses browser storage, optional presence data, and third-party services.</p></div>
      <div className="privacy-copy">
        ...
        <p>Google Fonts may receive ordinary technical request data when fonts load. The homepage requests public contribution data for the configured GitHub profile from github-contributions-api.jogruber.de. Supabase, Netlify, Google, Credly, and that public GitHub activity service may process technical request data according to their own policies when their respective features or external links are used.</p>
        <h3>Your choices</h3>
