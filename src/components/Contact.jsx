        ...
        <div className="contact-left">
          ...
          <Reveal className="contact-details" delay={100}>
            <p className="contact-lead">
              Have a project in mind, feedback on my work, or want to
              collaborate? Feel free to send a message or reach out directly.
            </p>
            ...
            <div className="contact-location">
              ...
              <span className="location-text">Cebu, Philippines · UTC+8</span>
            </div>
