...
export function CookieConsent() {
  ...
  if (consent) return <button type="button" className="cookie-settings" onClick={() => { localStorage.removeItem("haniel-cookie-consent"); window.dispatchEvent(new CustomEvent("cookie-consent", { detail: "reset" })); window.location.reload(); }}>Privacy settings</button>;
